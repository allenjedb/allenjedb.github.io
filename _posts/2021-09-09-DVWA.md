...
<p>Now let's try Remote File Inclusion, to test this I will start a python web server that will act as our malicious website that will host a reverse shell.<img src="/assets/images/dvwa/FI/5.png" alt="" /><br>And then we will set up a Netcat listener to listen when our reverse shell gets executed.<img src="/assets/images/dvwa/FI/6.png" alt="" /><br></p>
