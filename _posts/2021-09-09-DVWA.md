...
<p>In the Bruteforcing section we can see a normal login page<img src="/assets/images/dvwa.png" alt="" />we can try entering any cred and see how it will react, let's try admin:admin</p>
