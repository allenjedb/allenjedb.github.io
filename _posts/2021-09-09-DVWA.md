...
<p>In the Bruteforcing section we can see a normal login page<img src="/assets/images/dvwa/bruteforcing/1.png" alt="" />we can try entering any cred and see how it will react, let's try admin:admin</p>

<div style="height:60px;width:1000px;border:1px solid #ccc;font:16px/26px;overflow:auto;">
