...
<p>I will use the worldlist probable-v2-top1575 from the <a href="https://github.com/danielmiessler/SecLists"> Seclists</a> collection. After loading the wordlist we can now proceed to bruteforcing - Click Attack. Sort the results according to lenght and from here you will see one entry with different value which 5007 for password.<br><img src="/assets/images/dvwa/bruteforcing/6.png" alt="" /></p>

<p>if we try to login using the result we will get the following<img src="/assets/images/dvwa/bruteforcing/7.png" alt="" /> If we try to inspect element we can see the location of the image<img src="/assets/images/dvwa/bruteforcing/8.png" alt="" />And after browsing to the directory we will see the other probable users.<img src="/assets/images/dvwa/bruteforcing/9.png" alt="" /></p>
